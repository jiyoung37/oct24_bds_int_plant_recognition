...
It includes multiple subfolders; Train, Valid and Test. These subfolders contain subfolders per plant where the target image files (jpg) are stored, totalling 87,900 images.
    ...
    Total files:                    87,900
        ...
        st.image("./../visualization/Plants_&_Diseases_count.png", use_column_width = True)
    
    with tab2: # Plants & diseases
        st.write("")
        st.image("./../visualization/diseased_plant_samples.png")

        st.write("")
        st.image("./../visualization/healthy_plant_samples.png")
